    ...
    <GenUIProvider onNavigate={handleNavigate}>
      ...
      {(isDemoActive
        ? currentStep.app !== 'email-marketplace'
          ...
          && !bfiLoginActive
          && !(isBFI && ['r1.6'].includes(currentStep.id))
      ...
      <main className={`transition-all duration-300 ${(isDemoActive ? currentStep.app !== 'email-marketplace' && currentStep.app !== 'wrg-estimator' && currentStep.app !== 'workspaces-submit' && !bfiLoginActive && !(isBFI && ['r1.6'].includes(currentStep.id)) : currentPage !== 'detail' && currentPage !== 'workspace') ? 'pt-16' : ''} ${isDemoActive ? (isSidebarCollapsed ? 'pl-0' : 'pl-80') + ' animate-in fade-in duration-500' : ''} min-h-screen bg-background`}>
