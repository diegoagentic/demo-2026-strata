...
export const MBI_MODULE_PHASES: ModulePhase[] = [
    // ═══ ACCOUNTING AI ═══════════════════════════════════════════════════════
    {
        ...
        deliverables: [
            ...
            'Vendor invoice template inventory (top 30 manufacturers)',
    ...
    },
    {
        ...
        summary: 'Kathy stops typing invoices. Document AI + non-EDI recon ship.',
        deliverables: [
            'Document AI invoice ingestion → CORE pre-fill',
    ...
    },
    {
        ...
        deliverables: [
            ...
            'Installer invoice vs PO via Teams workflow',
        ],
