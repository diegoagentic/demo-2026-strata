...
export const MBI_MANUFACTURERS: Manufacturer[] = [
    { id: 'allsteel', name: 'Vertex Office', isEDI: true, compassValidated: true, color: '#FF6B35' },
    { id: 'hni', name: 'HNI', isEDI: true, compassValidated: true },
    { id: 'gunlocke', name: 'Northgate', isEDI: true, compassValidated: true },
    { id: 'hon', name: 'Meridian Office', isEDI: true, compassValidated: true },
    { id: 'kimball', name: 'Summit Interiors', isEDI: true },
