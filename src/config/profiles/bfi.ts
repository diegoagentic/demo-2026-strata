...
export const BFI_STEPS: DemoStep[] = [
    ...
    },
    {
        ...
        description: 'Three actions in one step: ① validate pricing in Quote Tool, ② confirm the per-line credit line CORE prepared (Method 3 · per CoNY Contract ANT122 · GP visible per product at booking), ③ email WIG for the labor quote.',
        app: 'bfi-agency-fee',
        role: 'Account Manager',
    },
    {
...
export const BFI_STEP_MESSAGES: Record<string, string[]> = {
    ...
    'a1.2b': [
        ...
        'Reading per-line credit line from CORE · Method 3 (Jessica\'s preferred)',
