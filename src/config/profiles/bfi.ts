...
export const BFI_STEPS: DemoStep[] = [
    ...
    },
    {
        ...
        description: 'Robert Chen (Miller Knoll designer) receives an email confirmation for order Q-2026-0089. Lauren sent the update directly from Strata after validating the SIF. Before Strata, Robert waited 1–2 business days for a manual email — with no system visibility. Now the loop closes in seconds.',
        app: 'bfi-agency-fee',
        role: 'Designer',
    },
    {
        ...
        description: 'Strata validates the SIF against the CoNY contract through OmniQuote — correcting one price on Filing Units ($8,100 → $7,560) — then calculates the discount automatically. What used to take 65 minutes takes seconds.',
        app: 'bfi-agency-fee',
        role: 'Account Manager',
    },
    {
...
export const BFI_STEP_MESSAGES: Record<string, string[]> = {
    ...
    'a1.2b': [
        ...
        'Validating SIF against CoNY contract through OmniQuote',
