...
export const BFI_STEPS: DemoStep[] = [
    ...
    },
    {
        ...
        description: 'Strata validates the SIF against the CoNY contract through OmniQuote, corrects the Filing Units price, and calculates the discount automatically.',
        app: 'bfi-agency-fee',
        role: 'Account Manager',
    },
    {
