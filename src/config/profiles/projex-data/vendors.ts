...
export const PROJEX_VENDORS: Vendor[] = [
    // ─── Furniture · direct product (Teknion is ~70% of volume) ───
    {
        ...
        notes: '~70% of Projex product volume · SIF upload via Teknion Online · direct-bill NCBA + MWH projects',
        billsLast12mo: 187,
        activelyPaid: true,
    },
    {
...
export const PROJEX_VENDOR_TOTALS = {
    migrated: 733,
    activelyPaid: 389,
    furnitureList: 200,
...
export function getVendor(id: string): Vendor | undefined {
    return PROJEX_VENDORS.find(v => v.id === id)
}
