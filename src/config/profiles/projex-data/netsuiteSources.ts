...
// Extiende el DS `SOURCES` catalog con connectors Projex-specific:
// NetSuite (PO / Bill / GL) · SharePoint (accounting private) · AP inbox ·
...
export const PROJEX_SOURCES = {
    // ─── NetSuite (Projex ERP · v2024) ───
    NETSUITE_PO: {
        name: 'NetSuite · POs',
    ...
    // ─── AP intake surface (Jacob verbatim: "ap@projex-inc.com") ───
    AP_INBOX_PJX: {
        name: 'AP inbox · Projex',
        type: 'communication' as SourceType,
        note: 'ap@projex-inc.com · vendor invoices arrive as PDF attachments overnight. Strata sweeps every ~5 min.',
    },
    ...
    TEKNION_ONLINE: {
        ...
        note: 'Teknion order portal · ~70% of Projex order volume · SIF upload + ACK download.',
    },
    VENDOR_PORTAL_HBF: {
        name: 'HBF portal',
        type: 'external' as SourceType,
    ...
    FINANCIAL_DASHBOARD: {
        ...
        type: 'external' as SourceType,
        note: 'Excel deck reviewed Tuesday · AR aging tab + AP payables tab · CEO + accounting review together.',
    },
