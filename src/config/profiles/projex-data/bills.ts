...
// SOT §12a · AP intake baseline · 224 bills/mo · 287 Q4 peak · sample 14 bills
...
export type BillEntity = 'projex-inc' | 'projex-corp' | 'culture-llc'
...
export interface Bill {
    id: string
    vendorId: string           // FK to PROJEX_VENDORS
...
export const PROJEX_MORNING_SUMMARY = {
    totalReceived: 14,
    autoMatched: 12,
    exceptions: 2,
    breakdown: {
    ...
    entityBreakdown: {
        projexInc: 10,      // Bills for Projex Inc.
        projexCorp: 3,      // Bills for Projex Corp.
...
export function getBill(id: string): Bill | undefined {
    return PROJEX_BILLS_OVERNIGHT.find(b => b.id === id)
}
