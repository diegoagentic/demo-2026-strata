...
export const CLC_STEPS: DemoStep[] = [
    ...
    },
    {
        ...
        description: 'Drag a Fairport Public Library install card from Jun 2 to Jun 5. The change queues for the nightly IQ batch sync · IQ has no write-back API, so the platform stages the change with a "Queued for IQ batch sync" chip. Operator confirms or reverts.',
        app: 'clc-calendar',
        role: 'Director of Operations',
        flowId: 'calendar',
    },
