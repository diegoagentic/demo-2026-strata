...
export const PROJEX_STEPS: DemoStep[] = [
    ...
    // ═══════════════════════════════════════════
    {
        ...
        title: 'AP inbox sweep · 12 overnight matches ready for Daniel',
    ...
    },
    {
        ...
        groupId: 1,
        groupTitle: 'AP intake & matching',
        title: 'Install-vendor bill without PO # · PM double-check email to Jeff',
    ...
    },
    {
        ...
        groupId: 1,
        groupTitle: 'AP intake & matching',
        title: 'Tue payment run · dashboard review · Matt approves ACH batch',
    ...
    // ═══════════════════════════════════════════
    {
        ...
        title: 'Coordinator requests new vendor · Kelly submits structured intake · attach W-9',
    ...
    },
    {
        ...
        groupId: 2,
        groupTitle: 'Vendor onboarding',
        title: 'W-9 upload + OCR extraction · Daniel reviews 5 fields staggered',
    ...
    },
    {
        ...
        groupId: 2,
        groupTitle: 'Vendor onboarding',
        title: 'Jacob compliance sign-off gate · release / reject with reason',
    ...
    },
    {
        ...
        groupId: 2,
        groupTitle: 'Vendor onboarding',
        title: 'Vendor master registry · #734 populates NetSuite con expiration chip',
        description: 'Auto. NetSuite Vendor master receives the new vendor · row #734 highlighted animate-in-from-bottom en la registry grid. Data list muestra 733 vendor rows + el nuevo. Expiration chip por row (W-9 age 30-day-out warning · fresh green · expired destructive). Filter por expiration bucket · search por MFG code o vendor name.',
        app: 'projex-vendor-onboarding',
        role: 'System',
        flowId: 'projex-vendor-onboarding',
    },
    {
        ...
        groupId: 2,
        groupTitle: 'Vendor onboarding',
        title: 'Dealer readiness self-service · Kelly sees vendor status per project',
    ...
    },
    {
        ...
        groupId: 3,
        groupTitle: 'Progress billing & collections',
        title: 'Coordinator proforma review · Isabella adjusts line items + deposit deducted',
    ...
    },
    {
        ...
        groupId: 3,
        groupTitle: 'Progress billing & collections',
        title: 'Walls PM-review gate (WC9) · Alec hands off to Stacy for installation-complete confirm',
    ...
    },
    {
        ...
        groupId: 3,
        groupTitle: 'Progress billing & collections',
        title: 'AI-drafted collection emails · shared queue (Isabella + Alec)',
    ...
    },
    {
        ...
        description: '26 vendor POs drafted en flat batch grid · 6 vendors visible (Teknion 3 POs · HBF 2 · Boss 2 · Alamir 2 · Nelson 1 · West Elm 1 + 14 batched). Per-card DiffViewer muestra auto-draft vs prior human baseline · ConversionStatusBadge (draft/ready/needs-review). Never one-batch button (FC6 fix).',
        app: 'projex-order-po',
        role: 'Furniture Coordinator',
        flowId: 'projex-order-po',
    },
    {
        ...
        groupId: 4,
        groupTitle: 'Order entry & PO dispatch',
        title: 'Per-vendor Send · Isabella releases Teknion first · HBF hold',
    ...
    // ═══════════════════════════════════════════
    {
        ...
        title: 'Teknion Online SIF upload · 70% del volumen + email tail 30%',
        description: 'PO-2026-4421 (NCBA) SIF uploaded a Teknion Online (~70% del Projex volumen es Teknion direct-bill via SIF upload). Otros vendors (30% tail · HBF · Boss · Alamir · Nelson · West Elm) via email PDF con SourceBadge visible. Split view mock Teknion Online browser panel + PO summary card + progress bar SIF upload.',
        app: 'projex-ack',
        role: 'System',
        flowId: 'projex-ack',
    },
    ...
    },
    {
        ...
        description: 'AckHeroMatchPanel UN-CUTTABLE hero. Split-pane ACK PDF izq · PMO grid der · row-by-row diff. Teknion CR taxonomy real (leadtime · BIFMA advisory · width change · pricer comment) · 13 CRs visible · 5 warn (width changes + leadtimes con impact) + 8 info (BIFMA advisories · pricer notes). ThreeWayMatchView per line con status icons.',
        app: 'projex-ack',
        role: 'Furniture Coordinator',
        flowId: 'projex-ack',
    },
    ...
    },
    {
        ...
        groupId: 5,
        groupTitle: 'Electronic ordering & ACK',
        title: 'Designer chain assembly · Layne → Tate → Josh (FC8 net-new)',
...
export const PROJEX_STEP_BEHAVIOR: Record<string, StepBehavior> = {
    ...
    'p1.5': { mode: 'interactive', userAction: 'Matt approves the Tue payment run batch' },
    'p1.6': { mode: 'auto', duration: 5000, aiSummary: 'Bill saved · PDF filed · audit trail complete' },
    // F2 · vendor onboarding · 6 steps (Kelly → Daniel → Jacob → Registry → Kelly)
    'p2.1': { mode: 'interactive', userAction: 'Kelly types vendor + attaches W-9' },
    'p2.2': { mode: 'interactive', userAction: 'Daniel validates 5 W-9 fields · OCR conf per field' },
    'p2.3': { mode: 'auto', duration: 4500, aiSummary: 'Preflight running · 4 compliance checks staggered' },
    'p2.4': { mode: 'interactive', userAction: 'Jacob reviews · Release or Reject with reason' },
    'p2.5': { mode: 'auto', duration: 3500, aiSummary: 'Vendor #734 saved · animated arrival in NetSuite registry' },
    'p2.6': { mode: 'interactive', userAction: 'Kelly reviews expiration reminders + sends refresh emails' },
    // F3 · progress billing · 6 steps
    'p3.1': { mode: 'auto', duration: 4500, aiSummary: 'Fairport crosses 50% threshold · proforma drafted' },
    'p3.2': { mode: 'interactive', userAction: 'Isabella reviews proforma · adjusts lines · approve' },
    'p3.3': { mode: 'interactive', userAction: 'Alec handoff to Stacy · installation-complete confirm' },
    ...
    'p4.1': { mode: 'interactive', userAction: 'Isabella opens PIF email · confirms ingest' },
    'p4.2': { mode: 'auto', duration: 5500, aiSummary: 'Parsing MWH PIF · 300 lines vertical con AI lot line' },
    'p4.3': { mode: 'interactive', userAction: 'Isabella adds 26 S&H manual entries' },
    'p4.4': { mode: 'interactive', userAction: 'Explore 26 PO batch grid · click card para DiffViewer' },
    'p4.5': { mode: 'interactive', userAction: 'Per-vendor Send · Teknion primero · never one-batch' },
    'p4.6': { mode: 'auto', duration: 4000, aiSummary: 'Snapshot tri-way match + audit trail · 26 POs sent' },
    // F5 · electronic ordering & ACK · 6 steps
    'p5.1': { mode: 'auto', duration: 4500, aiSummary: 'SIF uploaded a Teknion Online · 70% del volumen · email tail' },
    ...
    'p5.5': { mode: 'interactive', userAction: 'Review Layne → Tate → Josh designer chain thread' },
...
export const PROJEX_STEP_MESSAGES: Record<string, string[]> = {
    ...
    'p3.4': [
        ...
        'Net 10 + 1.5%/mo late fee · click row abre hold-review modal',
    ],
    'p3.5': [
    ...
    'p4.2': [
        'Auto · PIF parse con 300 lines vertical',
    ...
    // F5 · electronic ordering & ACK · 6 steps
    'p5.1': [
        'PO-2026-4421 SIF uploaded a Teknion Online',
        '~70% del volumen es Teknion direct-bill',
        'Email tail 30% con SourceBadge per vendor',
        'Split view mock browser + PO summary + progress bar',
    ],
    'p5.2': [
        'ACK PDFs return drip-drip por vendor',
