...
//
// 15 STEPS · 3 per path:
//   F1 · AP intake & matching        p1.1 · p1.2 · p1.3
...
export const PROJEX_STEPS: DemoStep[] = [
    ...
    // ═══════════════════════════════════════════
    {
        ...
        title: 'AI reads bills · OCR ingests the AP mailbox',
        description: 'Strata OCR sweeps ap@projex-inc.com overnight and files 14 vendor bills in the queue. Teknion NCBA + Warehouse-by-Design flagged for review.',
        app: 'projex-ap',
...
export const PROJEX_STEP_BEHAVIOR: Record<string, StepBehavior> = {
    // F1 · AP
    'p1.1': { mode: 'auto', duration: 6000, aiSummary: 'OCR sweeps AP inbox · 14 bills filed overnight' },
...
export const PROJEX_STEP_MESSAGES: Record<string, string[]> = {
    'p1.1': [
        'Email Capture watching ap@projex-inc.com · 14 bills ingested overnight',
    ...
    'p5.1': [
        ...
        'Same shell as F1 AP inbox · Coordinator familiar',
    ],
    'p5.2': [
...
export const PROJEX_PATH_LANDINGS: Record<ProjexFlowId, ProjexPathLanding> = {
    'projex-ap': {
        ...
        heroStepId: 'p1.1',
        moments: [
            { stepId: 'p1.1', title: 'AI reads bills', description: 'OCR ingests the AP mailbox · 14 bills filed overnight', estTime: '30 sec', isCore: true },
...
export const PROJEX_PRESENTER_NOTES: Record<string, ProjexPresenterNote> = {
    ...
    'p1.1': {
        say: 'This is what Strata does overnight. It reads every vendor bill from your AP mailbox and files them here · the same OCR queue Compliance already uses. 14 bills tonight · Teknion NCBA and Warehouse-by-Design flagged for review.',
    ...
    'p1.3': {
        ...
        next: 'End of AP path. Switch paths in the sidebar.',
    },
