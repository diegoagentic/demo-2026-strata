...
// Bucket helper (net-new per feedback-acme-dealer-net-new-gaps)
...
export const ACME_DEALER_AR_RECORDS: ARRecord[] = [
    // 0-30 bucket · current
...
export const ACME_DEALER_MILESTONES: BillingMilestone[] = [
    {
...
Thanks —
Isabella · Acme Dealer Furniture Coordination`,
    },
    {
        id: 'DRFT-02',
        recordId: 'AR-3395',
...
Per contract, please remit at your earliest convenience or reply with expected pay date. Escalating to Matt Magrann (Acme Dealer CEO) if we do not hear back this week.
...
Per Acme Dealer policy this account is escalated to Jacob Swearingen (Director of Accounting) for collection follow-up. Please reach out with a resolution path this week or we\'ll begin next-step collections process.
...
Thanks —
Alec · Acme Dealer Walls Director`,
    },
]
