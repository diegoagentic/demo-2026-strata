...
export type BillEntity = 'acme-dealer-inc' | 'acme-dealer-corp' | 'culture-llc'
...
export interface Bill {
    id: string
    vendorId: string           // FK to ACME_DEALER_VENDORS
...
export const ACME_DEALER_MORNING_SUMMARY = {
    totalReceived: 14,
    autoMatched: 12,
    exceptions: 2,
    breakdown: {
    ...
    entityBreakdown: {
        acmeDealerInc: 10,      // Bills for Acme Dealer Inc.
        acmeDealerCorp: 3,      // Bills for Acme Dealer Corp.
...
export function getBill(id: string): Bill | undefined {
    return ACME_DEALER_BILLS_OVERNIGHT.find(b => b.id === id)
}
