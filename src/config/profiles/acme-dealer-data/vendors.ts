...
export const ACME_DEALER_VENDORS: Vendor[] = [
    // ─── Furniture · direct product (Teknion is ~70% of volume) ───
    {
        ...
        notes: '~70% of Acme Dealer product volume · SIF upload via Teknion Online · direct-bill NCBA + MWH projects',
        billsLast12mo: 187,
        activelyPaid: true,
    },
    {
...
export const ACME_DEALER_VENDOR_TOTALS = {
    migrated: 733,
    activelyPaid: 389,
    furnitureList: 200,
...
export function getVendor(id: string): Vendor | undefined {
    return ACME_DEALER_VENDORS.find(v => v.id === id)
}
