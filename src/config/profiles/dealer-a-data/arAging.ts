...
// Bucket helper (net-new per feedback-dealer-a-net-new-gaps)
...
export const DEALER_A_AR_RECORDS: ARRecord[] = [
    // 0-30 bucket · current
...
export const DEALER_A_MILESTONES: BillingMilestone[] = [
    {
...
Thanks —
Isabella · Dealer A Furniture Coordination`,
    },
    {
        id: 'DRFT-02',
        recordId: 'AR-3395',
...
Per contract, please remit at your earliest convenience or reply with expected pay date. Escalating to Matt Magrann (Dealer A CEO) if we do not hear back this week.
...
Per Dealer A policy this account is escalated to Jacob Swearingen (Director of Accounting) for collection follow-up. Please reach out with a resolution path this week or we\'ll begin next-step collections process.
