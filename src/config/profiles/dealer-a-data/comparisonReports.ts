/**
 * F84 · Dealer A ComparisonReport seeds for F1 p1.2 (PO ⇄ Bill) + F5 p5.2 (PMO ⇄ ACK).
 * Uses the ComparisonReport shape from
 * vendor/prod-imports/deps/comparison/comparisonTypes.ts · Dealer A-specific
...
export const DEALER_A_F1_PO_BILL_REPORT: ComparisonReport = {
    report_id: 84001,
...
export const DEALER_A_F5_ACK_PO_REPORT: ComparisonReport = {
    report_id: 84005,
