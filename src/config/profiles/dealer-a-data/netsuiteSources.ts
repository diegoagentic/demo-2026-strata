...
// Extiende el DS `SOURCES` catalog con connectors Dealer A-specific:
...
export const DEALER_A_SOURCES = {
    // ─── NetSuite (Dealer A ERP · v2024) ───
    NETSUITE_PO: {
        name: 'NetSuite · POs',
    ...
    // ─── Bills intake surface (Jacob verbatim: "bills@dealer-a.com") ───
    AP_INBOX_PJX: {
        name: 'Bills inbox · Dealer A',
        type: 'communication' as SourceType,
        note: 'bills@dealer-a.com · vendor invoices arrive as PDF attachments overnight. Strata sweeps every ~5 min.',
    },
    ...
    TEKNION_ONLINE: {
        ...
        note: 'Teknion order portal · ~70% of Dealer A order volume · SIF upload + ACK download.',
    },
    VENDOR_PORTAL_HBF: {
        name: 'HBF portal',
        type: 'external' as SourceType,
