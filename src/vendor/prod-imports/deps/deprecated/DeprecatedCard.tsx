// ─────────────────────────────────────────────────────────────────────────────
// F83.K.fix · lift DeprecatedCard.tsx from expert-hub prod (2026-08-21).
// SOURCE: expert-hub/src/components/deprecated/DeprecatedCard.tsx
// COMMIT: master · Do not edit in place · re-sync from source when prod evolves.
// Missing sibling of DeprecatedGrid.tsx (lifted F83.D+E · 52ccd3c) caused Vite
// import-analysis failure locally + Vercel build failure. Zero adaptations ·
// pure copy · sibling imports resolve within demo-2026-strata/src/vendor/prod-imports/deps/.
// ─────────────────────────────────────────────────────────────────────────────
...
export default function DeprecatedCard({ doc, onPreview, onRestore, onDownloadOriginal }: DeprecatedCardProps) {
    ...
    // silence unused import (AlertOctagon retained for parity with prod imports)
    void AlertOctagon
