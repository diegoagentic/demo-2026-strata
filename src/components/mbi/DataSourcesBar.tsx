...
export const SOURCES = {
    ...
    OVNIQ:          { name: 'OVNIQ',              type: 'external'      as SourceType, note: 'Herman Miller\'s validation platform. Checks SIF against the CoNY contract and auto-applies T-code rates.' },
