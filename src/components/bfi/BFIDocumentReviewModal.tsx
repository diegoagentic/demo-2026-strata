...
// ─── Labor Quote Dialog (Headless UI modal — same pattern as ClaimDialog) ────
                        ...
                        <DialogPanel className="w-full max-w-lg transform rounded-2xl bg-card border border-border shadow-2xl overflow-hidden flex flex-col max-h-[88vh]">
                            ...
                            <div className="flex items-center gap-3 px-5 py-3.5 border-b border-border bg-muted/30 shrink-0">
                                <div className="h-8 w-8 rounded-full bg-muted flex items-center justify-center shrink-0">
                                    <span className="text-[8px] font-black text-muted-foreground">WIG</span>
                                </div>
                                <div className="flex-1 min-w-0">
                                    <div className="text-[12px] font-bold text-foreground">Labor Quote Request · WIG</div>
                                    <div className="text-[10px] text-muted-foreground">DOE-2847 · Workplace Installation Group</div>
                                </div>
                                <button onClick={onClose} className="p-1 rounded-lg text-muted-foreground hover:text-foreground hover:bg-muted/50 transition-colors shrink-0" aria-label="Close">
                                    <X className="h-4 w-4" />
                                </button>
                                    ...
                                    {phase !== 'draft' && (
                                        <div className="bg-success/5 border border-success/30 rounded-xl p-3 flex items-start gap-2 animate-in fade-in duration-300">
                                            ...
                                            <div className="text-xs">
                                                ...
                                                <div className="text-muted-foreground mt-0.5">Awaiting labor quote from Michael Weller</div>
                                            </div>
                                        </div>
                                    )}
                                        ...
                                        <div className="rounded-xl border border-success/30 bg-success/5 overflow-hidden animate-in fade-in slide-in-from-bottom-2 duration-400">
                                            <div className="flex items-center gap-2.5 px-4 py-2.5 border-b border-success/20">
                                                <div className="h-7 w-7 rounded-full bg-success/20 flex items-center justify-center shrink-0">
                                                    <span className="text-[9px] font-black text-success">MW</span>
                                                </div>
                                                <div className="flex-1 min-w-0">
                                                    <p className="text-[11px] font-bold text-foreground">Michael Weller · WIG Install → Lauren DeMarco</p>
