...
export default function CLCCalendarScene() {
    ...
    return (
        <div className="flex flex-col h-full bg-muted/5">
            ...
            {/* Filter bar · data actions (Sync · Resync · Publish-all) live in the
                rightSlot so they sit AFTER the filters · semantically the actions
                belong to the data control row, not to the view-mode toolbar below. */}
            <CLCFilterBar
                dateRange={dateRange}
            ...
            {/* Toolbar row · jobs count on the left · view toggle on the right */}
