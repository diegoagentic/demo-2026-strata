/**
 * HOOK: useHighlightOnAcClick (Acme Dealer)
 * PURPOSE: Reusable listener para el Action Center CTA click. Cuando el AC
 *          event fires (e.g. `acme-dealer:jacob-gate-open`) · el hook:
 ...
 *
 *          Nota · el event NO debe estar en `AC_FALLBACK_EVENTS` (AcmeDealerPage)
 *          o el fallback listener también advance el step en paralelo.
 *          Agregar el event a `SCENE_HANDLED_EVENTS` para bypass fallback.
 *
 * USED BY: 8 Acme Dealer scenes (p2.4 · p2.6 · p3.2 · p3.3 · p3.5 · p4.1 · p4.5 · p5.4)
 */
