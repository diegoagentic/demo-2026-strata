/**
 * COMPONENT: AcmeDealerExperienceShell (Acme Dealer)
 * PURPOSE: Wraps every Acme Dealer scene with the platform chrome that matches the
 *          Capability Path's Experience assignment (per ProjeX_strata_solution
 *          _internal_3.html §04):
 *            F1 · Bills intake              → Expert Hub
...
export type AcmeDealerTab = ExpertHubTab | DealerTab
...
interface AcmeDealerExperienceShellProps {
    experience: AcmeDealerExperience
    activeTab: AcmeDealerTab
    /** Defaults to "Acme Dealer Inc." */
    tenantLabel?: string
    children: ReactNode
}

export default function AcmeDealerExperienceShell({
    experience,
    activeTab,
    tenantLabel = 'Acme Dealer Inc.',
    children,
}: AcmeDealerExperienceShellProps) {
