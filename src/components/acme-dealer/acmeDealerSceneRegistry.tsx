/**
 * COMPONENT: acmeDealerSceneRegistry (F81.B · 2026-08-21)
 * PURPOSE: Single source of truth for stepId → scene component mapping.
 *          Both AcmeDealerPage (guided tour · driven by currentStep) and
 *          AcmeDealerPathLanding (playlist model · hero scene inline · click
 *          tile to jump to that scene) consume this registry.
 *
 *          Extracted from the 30-case switch that lived in AcmeDealerPage.tsx ·
...
export const ACME_DEALER_SCENE_REGISTRY: Record<string, () => ReactNode> = {
    // F1 · AP
...
export function renderAcmeDealerScene(stepId: string): ReactNode | null {
    const factory = ACME_DEALER_SCENE_REGISTRY[stepId]
