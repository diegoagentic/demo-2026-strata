/**
 * COMPONENT: VendorInvoicePreview (Acme Dealer)
...
import type { Bill } from '../../config/profiles/acme-dealer-data/bills'
                ...
                <div className="grid grid-cols-[1.4fr_1fr] gap-6 mt-5">
                    <div>
                        ...
                        <div className="mt-1 text-[13px] leading-relaxed">
                            <div className="font-semibold"><span className={boxCls}>Acme Dealer Inc.</span></div>
                            <div>Bills</div>
                            <div>bills@acme-dealer.com</div>
