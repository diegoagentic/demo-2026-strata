/**
 * COMPONENT: AcmeDealerArrivalStrip (Acme Dealer)
 ...
 *
 * USED BY: 18 loose Acme Dealer scenes across F2/F3/F4/F5 (per audit 2026-08-17)
 * REUSE: AcmeDealerExperienceShell provides the platform chrome above · this strip
...
interface AcmeDealerArrivalStripProps {
...
const TONE_CLASSES: Record<NonNullable<AcmeDealerArrivalStripProps['focus']>['tone'] & string, string> = {
...
export default function AcmeDealerArrivalStrip({ breadcrumb, focus, hint }: AcmeDealerArrivalStripProps) {
