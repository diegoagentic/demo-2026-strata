/**
 * COMPONENT: projexSceneRegistry (F81.B · 2026-08-21)
 * PURPOSE: Single source of truth for stepId → scene component mapping.
 *          Both ProjexPage (guided tour · driven by currentStep) and
 *          ProjexPathLanding (playlist model · hero scene inline · click
 *          tile to jump to that scene) consume this registry.
 *
 *          Extracted from the 30-case switch that lived in ProjexPage.tsx ·
...
// F1 · AP intake & matching · 6 scenes (p1.1 → p1.6)
...
export const PROJEX_SCENE_REGISTRY: Record<string, () => ReactNode> = {
    // F1 · AP
...
export function renderProjexScene(stepId: string): ReactNode | null {
    const factory = PROJEX_SCENE_REGISTRY[stepId]
