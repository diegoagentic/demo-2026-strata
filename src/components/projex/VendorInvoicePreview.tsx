/**
 * COMPONENT: VendorInvoicePreview (Projex · F75)
...
import type { Bill } from '../../config/profiles/projex-data/bills'
                ...
                <div className="grid grid-cols-[1.4fr_1fr] gap-6 mt-5">
                    <div>
                        ...
                        <div className="mt-1 text-[13px] leading-relaxed">
                            <div className="font-semibold"><span className={boxCls}>Projex Inc.</span></div>
                            <div>Accounts Payable</div>
                            <div>ap@projex-inc.com</div>
