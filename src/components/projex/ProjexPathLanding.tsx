/**
 * COMPONENT: ProjexPathLanding (F81.B → F82.1 · 2026-08-21 · minimal)
 ...
 * USED BY: ProjexPage.tsx cuando `!hasBegunPath.has(activePathId)` (F81.D)
 */
...
export default function ProjexPathLanding({
    ...
    // a onStartGuided para backwards-compat (ProjexPage F81.D wired onStartGuided).
