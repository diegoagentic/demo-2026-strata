...
import { Camera, Plus, CheckCircle2, Clock, Sparkles, ChevronRight, Bell } from 'lucide-react'
                ...
                <div className="flex items-center justify-between px-3 pt-8 pb-2.5 border-b border-border/60 bg-card/40">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <div className="pl-1.5 border-l border-border">
                            ...
                            <p className="text-[11px] font-bold text-foreground leading-tight">Expense Submission</p>
                        </div>
                    </div>
                    {/* Right: user + bell */}
                    <div className="flex items-center gap-2">
