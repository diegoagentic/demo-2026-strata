/**
 * COMPONENT: DealerAExperienceShell (Dealer A)
 * PURPOSE: Wraps every Dealer A scene with the platform chrome that matches the
...
export type DealerATab = ExpertHubTab | DealerTab
