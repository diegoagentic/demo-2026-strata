/**
 * COMPONENT: DealerAPathLanding (F81.B → F82.1 · 2026-08-21 · minimal)
 ...
 *
 * SOURCE OF TRUTH: DEALER_A_PATH_LANDINGS in src/config/profiles/dealer-a.ts
 * USED BY: DealerAPage.tsx cuando `!hasBegunPath.has(activePathId)` (F81.D)
 */
...
interface DealerAPathLandingProps {
    pathId: DealerAFlowId
