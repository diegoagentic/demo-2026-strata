/**
 * COMPONENT: DealerAArrivalStrip (Dealer A)
 ...
 *
 * USED BY: 18 loose Dealer A scenes across F2/F3/F4/F5 (per audit 2026-08-17)
 * REUSE: DealerAExperienceShell provides the platform chrome above · this strip
...
interface DealerAArrivalStripProps {
...
const TONE_CLASSES: Record<NonNullable<DealerAArrivalStripProps['focus']>['tone'] & string, string> = {
...
export default function DealerAArrivalStrip({ breadcrumb, focus, hint }: DealerAArrivalStripProps) {
